...
IMAGE_NAME="docker.io/christianbueno1/aluna-ui"
CONTAINERFILE="Containerfile"
PAT_FILE="$HOME/Documents/docker-pat.txt"
DOCKER_USER="christianbueno1"
REGISTRY="registry-1.docker.io"
MANIFEST_FILE=aluna-ui-pod.yaml
SSH_ALIAS=az-odin
REMOTE_PATH=~/deployments/aluna-ui/
PODMAN_NETWORK_NAME=aluna-net
PODNAME=aluna-ui-pod
